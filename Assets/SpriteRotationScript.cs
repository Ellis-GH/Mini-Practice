...
public class SpriteRotationScript : MonoBehaviour
{
    ...
    private Direction horizontalDirection; //L/R
    private Direction verticalDirection; //U/D
    ...
    public void SetOrientation(Vector2 moveInput)
    {
        ...
        spriteRenderer.sprite = sprites[(int)horizontalDirection + (int)verticalDirection];
    }
}
